...
\begin{tabularx}{\textwidth}{@{}L{1.8cm} L{2.8cm} L{4cm} Y@{}}
  ...
  \taltrow 2.0 & 30/05/2026 & Equipe 9 & Segunda entrega. Parte 3: aplicação da primeira ferramenta AutoML, FLAML, com métricas, comparação a baselines simples, análise de erros por região e discussão de validade experimental. \\
  \bottomrule
\end{tabularx}
...
\begin{itemize}[leftmargin=1.2cm, topsep=2pt, itemsep=2pt]
  ...
  \item \textbf{v2.0} (este documento): Parte 3 - Aplicação da primeira ferramenta AutoML (FLAML), com baseline, análise de erros e discussão de validade.
\end{itemize}
\end{infobox}
...
% ==============================================================================
% SEÇÃO 3 - Aplicação da Primeira Ferramenta AutoML
% ==============================================================================
\newpage

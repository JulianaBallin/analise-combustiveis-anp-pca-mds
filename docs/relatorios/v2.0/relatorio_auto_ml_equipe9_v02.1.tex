% ==============================================================================
% Relatório AutoML v4.2 - Equipe 9
...
\hypersetup{
  ...
  urlcolor    = ueamint,
  citecolor   = ueagray,
  pdftitle    = {Relatório AutoML v4.2 - Equipe 9 - UEA Ciência de Dados},
...
\fancyfoot[R]{\textcolor{ueagray}{\small v4.2}}
...
\begin{titlepage}
  ...
  \vspace{2mm}
  {\small UEA $\cdot$ Equipe 9 $\bullet$ v4.2}
  \end{center}
  \vspace*{\fill}
\end{titlepage}
\restoregeometry
...
\begin{tabularx}{\textwidth}{@{}L{1.8cm} L{2.8cm} L{4cm} Y@{}}
  ...
  4.0 & 30/05/2026 & Equipe 9 & Ampliação da Parte 3 com comparação a baselines simples, análise de erros por região e discussão de validade experimental. \\
  \bottomrule
\end{tabularx}
...
\begin{itemize}[leftmargin=1.2cm, topsep=2pt, itemsep=2pt]
  ...
  \item \textbf{v4.2} (este documento): Parte 3 - versão ampliada com baseline, análise de erros e discussão de validade.
\end{itemize}
\end{infobox}
...
\begin{tabularx}{\textwidth}{@{}L{5.2cm} Y@{}}
  ...
  \taltrow Estratificação & Não aplicada na divisão final \\
...
\begin{figure}[H]
  \centering
  \IfFileExists{../../../outputs/figures/flaml_baseline_rmse.png}{%
    \includegraphics[width=0.78\textwidth]{../../../outputs/figures/flaml_baseline_rmse.png}
  }{%
    \fbox{\parbox{0.75\textwidth}{Figura \texttt{flaml\_baseline\_rmse.png} não encontrada.}}
  }
...
\begin{figure}[H]
  \centering
  \IfFileExists{../../../outputs/figures/flaml_mae_por_regiao.png}{%
    \includegraphics[width=0.78\textwidth]{../../../outputs/figures/flaml_mae_por_regiao.png}
  }{%
    \fbox{\parbox{0.75\textwidth}{Figura \texttt{flaml\_mae\_por\_regiao.png} não encontrada.}}
  }
...
\begin{figure}[H]
  \centering
  \IfFileExists{../../../outputs/figures/flaml_hist_erro_absoluto.png}{%
    \includegraphics[width=0.78\textwidth]{../../../outputs/figures/flaml_hist_erro_absoluto.png}
  }{%
    \fbox{\parbox{0.75\textwidth}{Figura \texttt{flaml\_hist\_erro\_absoluto.png} não encontrada.}}
  }

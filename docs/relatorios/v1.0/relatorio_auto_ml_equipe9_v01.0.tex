% ==============================================================================
% Relatorio AutoML v1.0 - Equipe 9
...
\hypersetup{
  ...
  urlcolor    = ueamint,
  citecolor   = ueagray,
  pdftitle    = {Relatorio AutoML v1.0 - Equipe 9 - UEA Ciencia de Dados},
  ...
  pdfkeywords = {AutoML, FLAML, LightAutoML, ANP, Combustiveis, Ciencia de Dados, UEA}
}
...
\newcommand{\uealogo}{%
  \IfFileExists{uea-logo.png}{%
    \raisebox{-3mm}{\includegraphics[height=14mm]{uea-logo.png}}%
...
\fancyfoot[R]{\textcolor{ueagray}{\small v1.0}}
...
\begin{titlepage}
  ...
  \begin{center}
    \IfFileExists{uea-logo.png}{%
      \begin{tikzpicture}
        \clip[rounded corners=2.8mm] (0,0) rectangle (55.3mm,28mm);
        \node[inner sep=0pt, anchor=south west] at (0,0)
          {\includegraphics[height=28mm]{uea-logo.png}};
      \end{tikzpicture}
    }{%
      {\fontsize{28}{34}\selectfont\textbf{UEA}}
    }\\[4mm]
    {\fontsize{13}{18}\selectfont Universidade do Estado do Amazonas}\\[2mm]
    {\fontsize{12}{16}\selectfont Escola Superior de Tecnologia}
  \end{center}

  \vspace{10mm}
  \noindent\textcolor{ueamint}{\rule{\textwidth}{1.5pt}}\\[5mm]
  {\fontsize{22}{28}\selectfont\textbf{Comparação de Ferramentas AutoML}}\\[4mm]
  {\fontsize{16}{22}\selectfont\textbf{FLAML e LightAutoML}}\\[4mm]
  {\fontsize{13}{18}\selectfont Aplicadas ao Dataset de Combustíveis ANP}\\[3mm]
  \noindent\textcolor{white}{\rule{\textwidth}{0.5pt}}

  \vspace{10mm}

  \begin{tabularx}{\textwidth}{@{}L{4cm} Y@{}}
    \textbf{Disciplina:}  & Ciência de Dados \\[3mm]
    \textbf{Equipe:}      & 9 \\[3mm]
    \textbf{Ferramentas:} & FLAML e LightAutoML \\[3mm]
    \textbf{Versão:}      & 1.0 \\[3mm]
    \textbf{Data:}        & 26 de maio de 2026 \\[3mm]
  ...
  \begin{center}
    \IfFileExists{../../diagrams/logo.png}{%
      \includegraphics[height=30mm]{../../diagrams/logo.png}
    }{}
  \end{center}

  \vspace{4mm}
  \noindent\textcolor{ueamint}{\rule{\textwidth}{0.5pt}}\\[3mm]
  \justifying
  {\small Este relatório apresenta a Parte 1 (explicação teórica sobre AutoML) e a
  Parte 2 (descrição do dataset utilizado), como primeira entrega da atividade de
  comparação de ferramentas AutoML da disciplina de Ciência de Dados na UEA.}

  \vspace{4mm}
  {\small \textcopyright{} 2026 Equipe 9, Ciência de Dados, UEA. Uso acadêmico.}

  \vspace{2mm}
  {\small UEA $\cdot$ Equipe 9 $\bullet$ 2 $\bullet$ v1.0}
\end{titlepage}
...
\begin{itemize}[leftmargin=1.2cm, topsep=2pt, itemsep=2pt]
  \item \textbf{v1.0} (este documento): Parte 1 - Explicação teórica sobre AutoML; Parte 2 - Descrição do dataset.
  \item \textbf{v2.0} (próxima entrega): Parte 3 - Aplicação da primeira ferramenta AutoML (FLAML).
...
\begin{tabularx}{\textwidth}{@{}L{4.5cm} Y@{}}
  ...
  \textbf{Periodo} & Janeiro de 2021 a dezembro de 2025 \\
